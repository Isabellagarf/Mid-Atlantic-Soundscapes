...
ES01_OL <- ES01_OL[complete.cases(CB01_OL), ]

timePlot(DB01_OL, pollutant= c("OL_500", "OL_1000", "OL_2000"), avg.time= "week", y.relation = "free", smooth= TRUE, date.format = "%b-%Y", ylab = (expression(paste("Octave Band SPL (dB re \u00b5Pa" ^ "2", "/Hz)"))))


calendarPlot(CB01_OL, pollutant= "OL_500", year = "2022")
