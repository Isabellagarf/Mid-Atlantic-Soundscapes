...
DB01_date_Time <- seq(ymd_hms("2022-07-07 00:00:00"), ymd_hms("2024-11-04 13:00:00"), by = "1 hour")

Sunset <- sunriset(crds = location, dateTime = DB01_date_Time, direction = "sunset", POSIXct.out = TRUE)
