...
```
#initial diel patterns for oyster toadfish chorus between sites- weekly medians- USING
```{r}
#DB01 oyster chorus: 9/9-9/15/2023

DB01subset_0909_0915 <-  seq(ymd_hms("2023-09-09 04:00:00"), ymd_hms("2023-09-16 03:00:00"), by = "1 hour")
...
DB01oysterQuants <- DB01oyster %>%
   group_by(UTC_hour) %>%
  summarize(quant05_800 = quantile(TOL_800, probs= quants[1], na.rm= TRUE),
            quant95_800 = quantile(TOL_800, probs= quants[2], na.rm= TRUE))
...
ggplot(DB01oysterMedQuants, aes(x= UTC_hour, y= med_800, group= 1))+
  geom_ribbon(aes(ymin= quant05_800,
                  ymax= quant95_800), 
              linetype= 1, linewidth= 0.2, alpha= 0.1)+
  geom_point(size= 1.5) + geom_line()+
  theme_bw()+
  xlab("Hour (UTC)")+
  ylab(expression(paste('Median 800Hz Third Octave Level SPL (db re 1 \u00b5Pa)')))+
  ggtitle("DB01 oyster toadfish- peak week median (9/9-9/15/2023)")+
   scale_x_continuous(limits = c(0, 24), breaks = seq(0, 22, by = 2))+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size= 16),
        axis.title= element_text(size= 18),
        axis.text.y= element_text(size= 16),
...
colnames(ES01oyster)[1] <- "UTC_fixed"
...
ES01oysterMed <- ES01oyster%>%
  dplyr::group_by(UTC_hour)%>%
  dplyr::summarise(
    med_250= median(OL_250, na.rm= TRUE))
quants= c(0.05, 0.95)
ES01oysterQuants <- ES01oyster %>%
   group_by(UTC_hour) %>%
  summarize(quant05_250 = quantile(OL_250, probs= quants[1], na.rm= TRUE),
            quant95_250 = quantile(OL_250, probs= quants[2], na.rm= TRUE))
...
ggplot(ES01oysterMedQuants, aes(x= hour, y= med_250, group= 1))+
  geom_ribbon(aes(ymin= quant05_250,
                  ymax= quant95_250), 
              linetype= 1, linewidth= 0.2, alpha= 0.1)+
  geom_point(size= 1.5) + geom_line()+
  theme_bw()+
  xlab("Hour (UTC)")+
  ylab(expression(paste('Median 250Hz Octave Level SPL (db re 1 \u00b5Pa)')))+
  ggtitle("ES01 oyster toadfish- peak week median (9/15-9/21/2024)")+
   scale_x_continuous(limits = c(0, 24), breaks = seq(0, 22, by = 2))+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size= 16),
        axis.title= element_text(size= 18),
        axis.text.y= element_text(size= 16),
...
CB01subset_0902_0908 <-  seq(ymd_hms("2023-09-02 04:00:00"), ymd_hms("2023-09-09 03:00:00"), by = "1 hour")
CB01oyster <- data.frame(UTC= CB01subset_0902_0908)
CB01oyster$UTC <- as.POSIXct(CB01oyster$UTC)
colnames(CB01oyster)[1] <- "UTC_fixed"
...
ggplot(CB01oysterMedQuants, aes(x= hour, y= med_250, group= 1))+
  geom_ribbon(aes(ymin= quant05_250,
                  ymax= quant95_250), 
              linetype= 1, linewidth= 0.2, alpha= 0.1)+
  geom_point(size= 1.5) + geom_line()+
  ...
  xlab("Hour (UTC)")+
  ylab(expression(paste('Median 250Hz Octave Level SPL (db re 1 \u00b5Pa)')))+
  ggtitle("CB01 oyster toadfish- peak week median (9/02-9/08/2023)")+
   scale_x_continuous(limits = c(0, 24), breaks = seq(0, 22, by = 2))+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size= 16),
        axis.title= element_text(size= 18),
        axis.text.y= element_text(size= 16),
...
ggplot(inshoreOyster_MedQuants, aes(x= hour, y= med_250, group= site, color= site))+
  geom_ribbon(aes(ymin= quant05_250,
                  ymax= quant95_250,
                  fill= site, color= site), linetype= 0, linewidth= 0.2, alpha= 0.1)+
  scale_fill_manual(values= c("#00797F",  "#003087",  "#B71300"))+
  ...
  xlab("Hour (UTC)")+
  ylab(expression(paste('Median 250Hz Octave Level SPL (db re 1 \u00b5Pa)')))+
  ggtitle("Oyster Toadfish: peak one-week period")+
  scale_color_manual(values= c("#00797F",  "#003087",  "#B71300"))+
  guides(color= guide_legend(title= "Site"))+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1, size= 16),
        axis.title= element_text(size= 18),
