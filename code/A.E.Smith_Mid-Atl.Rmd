...
tz='UTC', presenceDuration='1day', extraCols=c('site', 'UTC_date'), 
speciesCols=c('X500_chorus', 'X1000_chorus', 'cusk_chorus', 'oyster_chorus'), detectedValues='1') #this formats csv file so it can be used for detectionExplorer
...
plotAcousticScene(x=allSite_chorusPresenceFormatted, by='site', combineYears=FALSE, freqMap=data.frame(species=c('X1000_chorus', 'X500_chorus', 'cusk_chorus', 'oyster_chorus'), freqMin=c(140, 60, 1200, 150), freqMax=c(6500, 930, 2600, 3650)))+
  theme_bw()+
  ylim(15, 8000)+
  scale_fill_manual(values= c("#4B8320", "#00008B", "#DB2207","#FFAB38"))+
...
##########CB01 500###########
CB01_location <- matrix(c(-75.67, 36.98), nrow = 1)
CB01500_date_Time <- seq(ymd_hms("2024-05-23 00:00:00"), ymd_hms("2024-05-29 23:00:00"), by = "1 hour")
