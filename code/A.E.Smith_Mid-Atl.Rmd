...
CB011000_astrdusk_dechour <- CB011000_astrdusk %>%
  ...
  mutate(decimal_hour = hour + (min/60) + (sec/3600))
```
#inital diel patterns for 500/unknown pulse chorus between sites- weekly medians
```{r}
...
ggplot(inshore500_MedQuants, aes(x= UTC_hour, y= med_500, group= site, color= site))+
  geom_ribbon(aes(ymin= quant05_500,
                  ymax= quant95_500,
...
```
#initial diel patterns for 1000/unknown knock chorus between sites- weekly medians
```{r}
