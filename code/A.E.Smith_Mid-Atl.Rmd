...
my.geocode <- data.frame(lon = -74.82,
                         lat= 38.71,
                         address= "DB01")
mygeocode <- day_night(DB01subset_0916_0923, tz= "UTC",
          geocode= my.geocode)
...
my.CBgeocode <- data.frame(lon = -75.67,
                         lat= 36.98,
                         address= "CB01")
myCBgeocode <- day_night(CB01subset_0916_0923, tz= "UTC",
          geocode= my.CBgeocode)
