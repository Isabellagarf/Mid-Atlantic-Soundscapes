...
ggplot(inshore_sites_OL_22, aes(x= UTC_fixed, y= OL_2000, color = PLATFORM))+
...
runDetectionExplorer(DB01_chorusPresence)

plotAcousticScene(x=DB01_chorusPresence, combineYears=FALSE, freqMap=data.frame(species=c('X1000_chorus', 'X500_chorus', 'cusk_chorus', 'oyster_chorus'), freqMin=c(140, 61, 1200, 150), freqMax=c(6500, 930, 2600, 3500)))
