...
DB01_date_Time <- seq(ymd_hms("2022-07-07 00:00:00"), ymd_hms("2024-11-03 23:00:00"), by = "1 hour")
...
DB01_500Hz <- ggplot(DB01_sunrise, aes(x= UTC_fixed, y= OL_500))+
  geom_line(linewidth = 0.75)+
  scale_x_datetime(date_breaks = "3 months", date_labels= "%b %Y", minor_breaks = NULL)+
  theme_bw()+
  xlab("Date")+
...
DB01_2000Hz <- ggplot(DB01_sunrise, aes(x= UTC_fixed, y= OL_2000))+
  geom_line(linewidth = 0.75)+
  scale_x_datetime(date_breaks = "3 months", date_labels= "%b %Y", minor_breaks = NULL)+
  theme_bw()+
  xlab("Date")+
...
DB01_rollingmed <- rollmedian(DB01_sunset, 9, align = "right")
