...
```
#individual choruses diel plots full effort
```{r}
#DB01
DB01_location <- matrix(c(-74.82, 38.71), nrow = 1)
...
DB01_nautduskPresence <- DB01_chorusPresence %>%
  right_join(DB01500_fullEffort_nautduskDate, join_by(UTC_date))
DB01_nautdusk <- DB01_OL %>%
  right_join(DB01_nautduskPresence, join_by(UTC_fixed))
...
DB01_nautdusk <- DB01_nautdusk[-c(1, 5:8, 10:15, 18, 21, 23:25, 27)]
DB01_nautdusk$diel <- "naut_dusk"
DB01_nautduskPlus <- DB01_nautduskPlus[-c(1:8, 10:14, 16, 18:22)]
#colnames(DB01_nautduskPlus)[3] <- "UTC_fixed"
#colnames(DB01_nautduskPlus)[1] <- "500_plus"
DB01_nautduskPlus$diel <- "plus"
DB01_nautduskMinus <- DB01_nautduskMinus[-c(1:8, 10:14, 16, 18:22)]
#colnames(DB01_nautduskMinus)[3] <- "UTC_fixed"
#colnames(DB01_nautduskMinus)[1] <- "500_minus"
...
ggplot(DB01_nautdusk_diels, aes(x= UTC_fixed, group= year(UTC_fixed), y= OL_500, group= X500_chorus, color= X500_chorus))+
