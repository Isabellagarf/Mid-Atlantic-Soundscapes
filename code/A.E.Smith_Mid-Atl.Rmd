...
ggplot(melted_all_OLSiteSeason, aes(x= OL_band, y = med_seasonal_SPL, color= season, group= season))+
  ...
  facet_grid(Lat ~ shore, switch= "y")+
  theme_bw()+
  xlab("Octave band (Hz)")+
  ylab(expression(paste('Octave-band sound pressure levels (db re 1 \u00b5Pa)')))#+
  scale_color_manual(values= c("purple", "darkgreen", "darkorange","lightblue"))
