...
plotPSD(x=midshore_sites, style='quantile', q=0.01, by='PLATFORM', facet='month')+
  ...
  scale_color_manual(labels= c("DB02", "ES02", "CB02", "CB03"), values= c("#00797F","#003087", "#B71300"))+
...
plotPSD(x=offshore_sites, style='quantile', q=0.01, facet='PLATFORM')+
  ...
  guides(color= guide_legend(title= "Month")) #add back to ggplot if using other PSDs
