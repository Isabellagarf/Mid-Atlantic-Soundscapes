...
ggplot(all_suntimes,aes(x=sun_time,y=OL_500))+
  geom_boxplot()+
  geom_text(data=sun500.summarized,aes(x=sun_time,y=1+MaxSPL, label=summary500$tukey_500),vjust=0)+
  facet_wrap(~PLATFORM)
...
ggplot(all_suntimes,aes(x=sun_time,y=OL_1000))+
  geom_boxplot()+
  geom_text(data=sun1000.summarized,aes(x=sun_time,y=1+MaxSPL, label=summary1000$tukey_1000),vjust=0)+
  facet_wrap(~PLATFORM)
...
ggplot(all_suntimes,aes(x=sun_time,y=OL_2000))+
  geom_boxplot()+
  geom_text(data=sun2000.summarized,aes(x=sun_time,y=1+MaxSPL, label=summary2000$tukey_2000),vjust=0)+
  facet_wrap(~PLATFORM)
...
suntimes_500 <- ggplot(data = all_suntimes,
  ...
  geom_boxplot(width = 0.9)+
  geom_text(data=sun500.summarized,aes(x=sun_time,y=1+MaxSPL, label=summary500$tukey_500),vjust=0)+
  stat_summary(fun.data = get_box_stats_suntimes500, geom = "text", hjust = 0.5, vjust = 0.5)+
  labs(x= "Time of day",
...
suntimes_1000 <- ggplot(data = all_suntimes,
  ...
  stat_boxplot(geom = "errorbar", width = 0.6)+
  geom_boxplot(width = 0.9)+
  stat_summary(fun.data = get_box_stats_suntimes1000, geom = "text", hjust = 0.5, vjust = 0.5)+
  labs(x= "Time of day",
...
suntimes_2000 <- ggplot(data = all_suntimes,
  ...
  stat_boxplot(geom = "errorbar", width = 0.6)+
  geom_boxplot(width = 0.9)+
  stat_summary(fun.data = get_box_stats_suntimes2000, geom = "text")+
  labs(x= "Time of day",
