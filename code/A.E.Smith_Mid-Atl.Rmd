...
DB_500 <- ggplot(DB01join_0916_0923, aes(x= UTC, y= OL_500))+
  ...
  ylab(expression(paste('Median 500Hz Octave Level SPL (db re 1 \u00b5Pa)')))+
  ggtitle("DB01 2022")+
  annotate(geom= "point", x=as.POSIXct("2022-09-20 23:59:00"), y= 135.0901, color= "red", size= 2)+
#  annotate(geom= "point", x=as.POSIXct("2022-09-21 00:00:00"), y= 135.0280, color= "green", size= 1)+
  annotate(geom= "point", x=as.POSIXct("2022-09-22 00:00:00"), y= 132.2585, color= "red", size= 2)+
  annotate(geom= "point", x=as.POSIXct("2022-09-23 00:05:00"), y= 130.7967, color= "red", size= 2)+
  annotate(geom= "point", x=as.POSIXct("2022-09-18 23:47:00"), y= 130.5401, color= "red", size= 2)+
#  annotate(geom= "point", x=as.POSIXct("2022-09-19 00:11:00"), y= 130.4963, color= "green", size= 1)+
  annotate(geom= "point", x=as.POSIXct("2022-09-17 23:57:00"), y= 126.0715, color= "red", size= 2)+
  annotate(geom= "point", x=as.POSIXct("2022-09-16 23:59:00"), y= 124.8383, color= "red", size= 2)+
  annotate(geom= "point", x=as.POSIXct("2022-09-24 00:00:00"), y= 129.6342, color= "red", size= 2)
...
```
#minute level data with confirmed fish presence
```{r}
